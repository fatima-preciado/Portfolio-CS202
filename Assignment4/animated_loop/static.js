...
function draw() {
    ...
    pulsationAmplitude = sin(frameCount * pulsationSpeed) * 10; // Adjust the range of pulsation
}
...
function drawPulsatingBlurredCircle(color, x, y, blurRadius, amplitude) {
    ...
    for (let i = 0; i < blurRadius; i++) {
        let pulsation = sin(frameCount * pulsationSpeed) * amplitude; // Calculate pulsation
